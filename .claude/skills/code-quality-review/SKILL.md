...
description: Review code quality, check for deprecated patterns, audit feature implementations, and verify adherence to project coding standards. Triggered when the user asks to "review code", "check quality", "audit feature", or "check for deprecated patterns".
---
